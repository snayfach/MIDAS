...
#outpath <- args[2] # Path to output pdf
...
# read in genome-cluster coverage
...
# get prevalence by cluster & population
...
# side-by-side boxplots of % covered
outpath <- "/mnt/data/work/pollardlab/snayfach/projects/strain_variation/microbe_cnv/application/pancoverage.pdf"
...
# boxplot of top 25 most prevalent genome-clusters
...
# write top 10 most prevalent genome-clusters to outfile
